...
```{r}
chapters <- GetChapters("https://archiveofourown.org/works/28747785")
```
...
chapter <- GET(
    ...
    read_html()
```
https://archiveofourown.org/downloads/28747785/To%20Take%20Down%20A%20King.html?updated_at=1619798356
```{r}
chapter %>%
  html_element(css = "#chapter-1") %>%
  html_text2() 
```
